# Hero HQ — Project Constitution (claude.md)
...
## B.L.A.S.T. A.N.T. 3-Layer Architecture
1. **Layer 1: Architecture (architecture/)** - Technical SOPs in Markdown. Goals, inputs, tool logic, edge cases. If logic changes, update SOP before code.
2. **Layer 2: Navigation** - The reasoning layer. Route data between SOPs and Tools.
3. **Layer 3: Tools (tools/)** - Deterministic Python scripts. Atomic and testable. `.tmp/` for intermediate operations.
